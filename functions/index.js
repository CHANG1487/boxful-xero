...
app.get('/xero/auth-url', verifyAuth, async (req, res) => {
    try {
        const scopes = 'openid profile email offline_access accounting.transactions.read accounting.invoices accounting.contacts accounting.settings.read accounting.reports.balancesheet.read accounting.reports.profitandloss.read accounting.reports.trialbalance.read accounting.reports.executivesummary.read';
